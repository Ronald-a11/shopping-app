...
class Command(BaseCommand):
    help = 'Update database with current OK and TM supermarket products and prices (2024)'
    ...
    def handle(self, *args, **options):
        ...
        categories_data = [
            ...
            {
                'name': 'Bakery & Grains',
                'description': 'Fresh bread, maize meal, and baked goods',
                'image': 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=300&fit=crop'
            },
            {
                'name': 'Pantry Staples',
                'description': 'Rice, cooking oil, salt, sugar and other essentials',
            ...
            },
            {
                ...
                'description': 'Chips, sweets, biscuits and snack foods',
        ...
        # Create products with current OK/TM supermarket prices (2024)
        products_data = [
            # Fresh Produce - Current 2024 prices
            {
                'name': 'Fresh Tomatoes (1kg)',
                'description': 'Fresh, locally grown tomatoes perfect for cooking and salads',
                'category': 'Fresh Produce',
                'price': Decimal('3.50'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Fresh Produce',
                'price': Decimal('4.20'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Fresh Produce',
                'price': Decimal('2.80'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Fresh Produce',
                'price': Decimal('3.20'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Fresh Produce',
                'price': Decimal('2.50'),  # Updated 2024 price
            ...
            {
                'name': 'Potatoes (2kg)',
                'description': 'Fresh potatoes, perfect for various cooking methods',
                'category': 'Fresh Produce',
                'price': Decimal('4.50'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=400&h=300&fit=crop',
                'stock_quantity': 45,
                'is_local_product': True,
                'supplier': 'Zimbabwe Potato Co.'
            },

            # Meat & Poultry - Current 2024 prices
            {
                'name': 'Beef Steak (500g)',
                'description': 'Premium beef steak, perfect for grilling',
                'category': 'Meat & Poultry',
                'price': Decimal('12.50'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=400&h=300&fit=crop',
                'stock_quantity': 20,
                'is_local_product': True,
            ...
            },
            {
                ...
                'category': 'Meat & Poultry',
                'price': Decimal('8.50'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Meat & Poultry',
                'price': Decimal('7.80'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=400&h=300&fit=crop',
                'stock_quantity': 15,
                'is_local_product': True,
            ...
            },
            {
                ...
                'description': 'Fresh chicken thighs, perfect for stews and grilling',
                'category': 'Meat & Poultry',
                'price': Decimal('6.50'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=400&h=300&fit=crop',
                'stock_quantity': 25,
                'is_local_product': True,
                'supplier': 'Zimbabwe Poultry Ltd'
            ...
            # Dairy & Eggs - Current 2024 prices
            {
                'name': 'Fresh Milk (1L)',
            ...
            },
            {
                ...
                'category': 'Dairy & Eggs',
                'price': Decimal('5.50'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Dairy & Eggs',
                'price': Decimal('6.80'),  # Updated 2024 price
            ...
            {
                'name': 'Butter (250g)',
                'description': 'Fresh butter, perfect for cooking and baking',
                'category': 'Dairy & Eggs',
                'price': Decimal('4.50'),  # Updated 2024 price
            ...
            },
            {
                ...
                'category': 'Bakery & Grains',
                'price': Decimal('5.20'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=300&fit=crop',
                'stock_quantity': 40,
                'is_local_product': True,
            ...
            # Pantry Staples - Current 2024 prices
            {
                'name': 'Cooking Oil (1L)',
                'description': 'Vegetable cooking oil, essential for cooking',
                'category': 'Pantry Staples',
                'price': Decimal('4.80'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=300&fit=crop',
                'stock_quantity': 50,
                'is_local_product': False,
                'supplier': 'Imported'
            },
            {
                ...
                'category': 'Pantry Staples',
                'price': Decimal('1.20'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=300&fit=crop',
                'stock_quantity': 60,
                'is_local_product': False,
                'supplier': 'Imported'
            },
            {
                ...
                'category': 'Pantry Staples',
                'price': Decimal('3.80'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=300&fit=crop',
                'stock_quantity': 40,
                'is_local_product': False,
                'supplier': 'Imported'
            ...
            },
            {
                ...
                'category': 'Beverages',
                'price': Decimal('1.80'),  # Updated 2024 price
            ...
            {
                'name': 'Tea Bags (50 pack)',
                'description': 'Black tea bags, perfect for morning tea',
                'category': 'Beverages',
                'price': Decimal('3.50'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=400&h=300&fit=crop',
                'stock_quantity': 40,
            ...
            # Snacks & Confectionery - Current 2024 prices
            {
            ...
            {
                'name': 'Biscuits (200g)',
                'description': 'Sweet biscuits, perfect with tea',
                'category': 'Snacks & Confectionery',
                'price': Decimal('2.80'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
                'stock_quantity': 30,
            ...
            # Household Items - Current 2024 prices
            {
            ...
            },
            {
                ...
                'category': 'Household Items',
                'price': Decimal('9.50'),  # Updated 2024 price
                'image': 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop',
                'stock_quantity': 20,
                'is_local_product': False,
                'supplier': 'Imported'
        ...
        self.stdout.write(
            self.style.SUCCESS('Successfully updated database with current OK/TM supermarket products and 2024 prices!')
        )
